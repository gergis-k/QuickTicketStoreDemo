...
namespace QuickTicketStoreDemo.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            ModelState.AddModelError(string.Empty, "Since this demo is just for testing, the maximum number of users is only 100. You can contact the owner to obtain the necessary credentials for the trial.");
